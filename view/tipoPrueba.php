        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="contact-us-form">
                    ...
                    <h2>Mantenimiento de Tipo Prueba</h2>
                    ...
                    <div class="row" id="frm">
                        <div class="col-lg-12">
                            <form class="form" name="formulario" id="formulario" method="post">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <label class="form-group" for="prueba">Prueba</label>
                                        <div class="form-group">
                                            <input type="text" name="prueba" id="prueba" required>
                                        </div>
...
<script type="text/javascript" src="scripts/tipoPrueba.js"></script>
