        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="contact-us-form">
                    ...
                    <h2>Mantenimiento de Padecimientos</h2>
                    ...
                    <div class="row" id="frm">
                        <div class="col-lg-12">
                            <form class="form" name="formulario" id="formulario" method="post">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <label class="form-group" for="padecimiento">Padecimiento</label>
...
<script type="text/javascript" src="scripts/padecimiento.js"></script>
