        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="contact-us-form">
                    ...
                    <h2>Mantenimiento de Tipo Sangre</h2>
                    ...
                    <div class="row" id="frm">
                        <div class="col-lg-12">
                            <form class="form" name="formulario" id="formulario" method="post">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <label class="form-group" for="tipo_sangre">Tipo Sangre</label>
                                        <div class="form-group">
                                            <input type="text" name="tipo_sangre" id="tipo_sangre" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
...
<script type="text/javascript" src="scripts/tipoSangre.js"></script>
