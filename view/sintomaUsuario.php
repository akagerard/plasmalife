                    ...
                    <div class="row" id="frm">
                        <div class="col-lg-12">
                            <form class="form" name="formulario" id="formulario" method="post">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <label class="form-group" for="resultado">Síntoma</label>
                                        <div class="form-group">
                                            <select class="form-control select2-show-search"
                                                    data-placeholder="Seleccionar" name="sintoma" id="sintoma"
                                                    required></select>
                                        </div>
                                    </div>
                                    <div class="col">
...
<script type="text/javascript" src="scripts/sintomaUsuario.js"></script>
